...
// after first inner loop   [3, 7, 4, 9, 42, 69, 420]; --> n-1 = 6
// after second inner loop  [3, 4, 7, 9, 42, 69, 420]; --> n-2 = 5
// after third inner loop   [3, 4, 7, 9, 42, 69, 420]; --> n-3 = 4
// after fourth inner loop  [3, 4, 7, 9, 42, 69, 420]; --> n-4 = 3
// after fifth inner loop   [3, 4, 7, 9, 42, 69, 420]; --> n-5 = 2
// after sixth inner loop   [3, 4, 7, 9, 42, 69, 420]; --> n-6 = 1
